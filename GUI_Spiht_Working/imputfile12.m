function [filename,ext,user_canceled] = imputfile12
...
%   $Revision: 1.1.6.9 $  $Date: 2011/02/09 18:56:15 $
...
% Show file chooser
returnVal = file_chooser.showSaveDialog(...
        javaObjectEDT('com.mathworks.mwswing.MJFrame'));
